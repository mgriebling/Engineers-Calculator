...
public class Scanner {
	...
	static var start: [Int: Int] { // maps first token character to start state
		...
		for i in 181...181 { result[i] = 6 }
		for i in 295...295 { result[i] = 6 }
		for i in 411...411 { result[i] = 6 }
		for i in 945...969 { result[i] = 6 }
		for i in 8734...8734 { result[i] = 6 }
	...
	func NextToken() -> Token {
		...
		loop: repeat {
			...
			case 6:
				...
				if ch >= "0" && ch <= "9" || ch >= "A" && ch <= "Z" || ch == "_" || ch >= "a" && ch <= "z" || ch == "\u{0B5}" || ch == "\u{0127}" || ch == "\u{019B}" || ch >= "\u{03B1}" && ch <= "\u{03C9}" || ch == "\u{0221E}" { AddCh(); state = 6 }
