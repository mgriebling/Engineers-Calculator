...
extension Decimal : FloatingPoint {
    ...
    public func isEqual(to other: Decimal) -> Bool { return self == other }
    public func isLess(than other: Decimal) -> Bool { return self < other }
    public func isLessThanOrEqualTo(_ other: Decimal) -> Bool { return self <= other }
