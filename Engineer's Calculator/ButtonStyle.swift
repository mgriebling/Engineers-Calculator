...
//
//  Created by Mike Griebling on 4 Feb 2018.
...
public class ButtonStyle : NSObject {
    ...
    @objc dynamic public class func drawAcos(frame targetFrame: NSRect = NSRect(x: 0, y: 0, width: 43, height: 22), resizing: ResizingBehavior = .aspectFit, trig: String = "cos") {
        //// General Declarations
        let context = NSGraphicsContext.current!.cgContext
        
        //// Resize to Target Frame
        NSGraphicsContext.saveGraphicsState()
        let resizedFrame: NSRect = resizing.apply(rect: NSRect(x: 0, y: 0, width: 43, height: 22), target: targetFrame)
        ...
        let textFontAttributes = [
            .font: NSFont(name: "HelveticaNeue", size: 20)!,
    ...
    @objc dynamic public class func drawReciprocal(frame targetFrame: NSRect = NSRect(x: 0, y: 0, width: 11, height: 16), resizing: ResizingBehavior = .aspectFit) {
        ...
        NSGraphicsContext.saveGraphicsState()
        text2Rect.clip()
        text2TextContent.draw(in: text2TextRect.offsetBy(dx: 0, dy: 2), withAttributes: text2FontAttributes)
        NSGraphicsContext.restoreGraphicsState()
        ...
        NSGraphicsContext.saveGraphicsState()
        text3Rect.clip()
        text3TextContent.draw(in: text3TextRect.offsetBy(dx: 0, dy: 2), withAttributes: text3FontAttributes)
        NSGraphicsContext.restoreGraphicsState()
    ...
    @objc dynamic public class func drawSquared(frame targetFrame: NSRect = NSRect(x: 0, y: 0, width: 23, height: 22), resizing: ResizingBehavior = .aspectFit) {
        ...
        text2Style.alignment = .left
        let text2FontAttributes = [
            .font: NSFont(name: "HelveticaNeue-Medium", size: 15)!,
            .foregroundColor: NSColor.black,
            .paragraphStyle: text2Style,
        ] as [NSAttributedStringKey: Any]
    ...
    @objc dynamic public class func drawNpower(frame targetFrame: NSRect = NSRect(x: 0, y: 0, width: 23, height: 22), resizing: ResizingBehavior = .aspectFit) {
        ...
        //// Text 2 Drawing
        let text2Rect = NSRect(x: 11, y: 9, width: 12, height: 16)
    ...
    @objc dynamic public class func drawCbrt(frame targetFrame: NSRect = NSRect(x: 0, y: 0, width: 27, height: 22), resizing: ResizingBehavior = .aspectFit) {
        ...
        text2Style.alignment = .left
        let text2FontAttributes = [
            .font: NSFont(name: "HelveticaNeue-Medium", size: NSFont.smallSystemFontSize)!,
            .foregroundColor: NSColor.black,
            .paragraphStyle: text2Style,
        ] as [NSAttributedStringKey: Any]
        ...
        NSGraphicsContext.saveGraphicsState()
        text2Rect.clip()
        text2TextContent.draw(in: text2TextRect.offsetBy(dx: 0, dy: 1.5), withAttributes: text2FontAttributes)
        NSGraphicsContext.restoreGraphicsState()
    ...
    @objc dynamic public class func drawFraction(frame targetFrame: NSRect = NSRect(x: 0, y: 0, width: 20, height: 26), resizing: ResizingBehavior = .aspectFit) {
        ...
        NSGraphicsContext.saveGraphicsState()
        textRect.clip()
        textTextContent.draw(in: textTextRect.offsetBy(dx: 0, dy: 2), withAttributes: textFontAttributes)
        NSGraphicsContext.restoreGraphicsState()
    ...
    @objc dynamic public class func drawXmean(frame targetFrame: NSRect = NSRect(x: 0, y: 0, width: 17, height: 31), resizing: ResizingBehavior = .aspectFit) {
        //// General Declarations
        let context = NSGraphicsContext.current!.cgContext
        
        //// Resize to Target Frame
        NSGraphicsContext.saveGraphicsState()
        let resizedFrame: NSRect = resizing.apply(rect: NSRect(x: 0, y: 0, width: 17, height: 31), target: targetFrame)
        context.translateBy(x: resizedFrame.minX, y: resizedFrame.minY)
        context.scaleBy(x: resizedFrame.width / 17, y: resizedFrame.height / 31)


        //// Group
        //// Text Drawing
        let textRect = NSRect(x: 3, y: 6, width: 13, height: 19)
        let textTextContent = "x"
        let textStyle = NSMutableParagraphStyle()
        textStyle.alignment = .left
        let textFontAttributes = [
        ...
        //// Bezier Drawing
        let bezierPath = NSBezierPath()
        bezierPath.move(to: NSPoint(x: 2.5, y: 21.5))
        bezierPath.curve(to: NSPoint(x: 13.5, y: 21.5), controlPoint1: NSPoint(x: 13.5, y: 21.5), controlPoint2: NSPoint(x: 13.5, y: 21.5))
        NSColor.black.setStroke()
        bezierPath.lineWidth = 2
        bezierPath.stroke()
    ...
    @objc dynamic public class func drawYmean(frame targetFrame: NSRect = NSRect(x: 0, y: 0, width: 16, height: 31), resizing: ResizingBehavior = .aspectFit) {
        //// General Declarations
        let context = NSGraphicsContext.current!.cgContext
        
        //// Resize to Target Frame
        NSGraphicsContext.saveGraphicsState()
        let resizedFrame: NSRect = resizing.apply(rect: NSRect(x: 0, y: 0, width: 16, height: 31), target: targetFrame)
        context.translateBy(x: resizedFrame.minX, y: resizedFrame.minY)
        context.scaleBy(x: resizedFrame.width / 16, y: resizedFrame.height / 31)
        ...
        //// Group
        //// Text Drawing
        let textRect = NSRect(x: 3, y: 5, width: 13, height: 22)
        let textTextContent = "y"
        let textStyle = NSMutableParagraphStyle()
        textStyle.alignment = .left
        let textFontAttributes = [
            .font: NSFont(name: "HelveticaNeue", size: 20)!,
    ...
    @objc dynamic public class func drawSumx(frame targetFrame: NSRect = NSRect(x: 0, y: 0, width: 26, height: 30), resizing: ResizingBehavior = .aspectFit) {
        //// General Declarations
        let context = NSGraphicsContext.current!.cgContext
        
        //// Resize to Target Frame
        NSGraphicsContext.saveGraphicsState()
        let resizedFrame: NSRect = resizing.apply(rect: NSRect(x: 0, y: 0, width: 26, height: 30), target: targetFrame)
        context.translateBy(x: resizedFrame.minX, y: resizedFrame.minY)
        context.scaleBy(x: resizedFrame.width / 26, y: resizedFrame.height / 30)
        ...
        //// Group
        //// Text Drawing
        let textRect = NSRect(x: 13, y: 3, width: 13, height: 22)
        let textTextContent = "x"
        let textStyle = NSMutableParagraphStyle()
        textStyle.alignment = .left
        let textFontAttributes = [
        ...
        //// Text 2 Drawing
        let text2Rect = NSRect(x: 0, y: 6, width: 15, height: 24)
        let text2TextContent = "∑"
        let text2Style = NSMutableParagraphStyle()
        text2Style.alignment = .left
        let text2FontAttributes = [
    ...
    @objc dynamic public class func drawSumy2(frame targetFrame: NSRect = NSRect(x: 0, y: 0, width: 35, height: 30), resizing: ResizingBehavior = .aspectFit) {
        //// General Declarations
        let context = NSGraphicsContext.current!.cgContext
        
        //// Resize to Target Frame
        NSGraphicsContext.saveGraphicsState()
        let resizedFrame: NSRect = resizing.apply(rect: NSRect(x: 0, y: 0, width: 35, height: 30), target: targetFrame)
        context.translateBy(x: resizedFrame.minX, y: resizedFrame.minY)
        ...
        //// Group
        //// Text Drawing
        let textRect = NSRect(x: 12, y: 2, width: 13, height: 22)
        let textTextContent = "y"
        let textStyle = NSMutableParagraphStyle()
        textStyle.alignment = .left
        let textFontAttributes = [
        ...
        //// Text 3 Drawing
        let text3Rect = NSRect(x: 23, y: 10, width: 12, height: 14)
    ...
    @objc dynamic public class func drawSumx2(frame targetFrame: NSRect = NSRect(x: 0, y: 0, width: 33, height: 31), resizing: ResizingBehavior = .aspectFit) {
        //// General Declarations
        let context = NSGraphicsContext.current!.cgContext
        
        //// Resize to Target Frame
        NSGraphicsContext.saveGraphicsState()
        let resizedFrame: NSRect = resizing.apply(rect: NSRect(x: 0, y: 0, width: 33, height: 31), target: targetFrame)
        context.translateBy(x: resizedFrame.minX, y: resizedFrame.minY)
        context.scaleBy(x: resizedFrame.width / 33, y: resizedFrame.height / 31)


        //// Text 2 Drawing
        let text2Rect = NSRect(x: 0, y: 7, width: 15, height: 24)
        let text2TextContent = "∑"
        let text2Style = NSMutableParagraphStyle()
        text2Style.alignment = .left
        let text2FontAttributes = [
        ...
        //// Symbol Drawing
        let symbolRect = NSRect(x: 10, y: 6, width: 23, height: 22)
        NSGraphicsContext.saveGraphicsState()
        symbolRect.clip()
        context.translateBy(x: symbolRect.minX, y: symbolRect.minY)

        ButtonStyle.drawSquared(frame: CGRect(origin: .zero, size: symbolRect.size), resizing: .stretch)
        NSGraphicsContext.restoreGraphicsState()
    ...
    @objc dynamic public class func drawSumy(frame targetFrame: NSRect = NSRect(x: 0, y: 0, width: 25, height: 31), resizing: ResizingBehavior = .aspectFit) {
        //// General Declarations
        let context = NSGraphicsContext.current!.cgContext
        
        //// Resize to Target Frame
        NSGraphicsContext.saveGraphicsState()
        let resizedFrame: NSRect = resizing.apply(rect: NSRect(x: 0, y: 0, width: 25, height: 31), target: targetFrame)
        context.translateBy(x: resizedFrame.minX, y: resizedFrame.minY)
        ...
        //// Group
        //// Text Drawing
        let textRect = NSRect(x: 12, y: 4, width: 13, height: 22)
        let textTextContent = "y"
        let textStyle = NSMutableParagraphStyle()
        textStyle.alignment = .left
        let textFontAttributes = [
    ...
    @objc dynamic public class func drawSigmax(frame targetFrame: NSRect = NSRect(x: 0, y: 0, width: 22, height: 25), resizing: ResizingBehavior = .aspectFit) {
        //// General Declarations
        let context = NSGraphicsContext.current!.cgContext
        
        //// Resize to Target Frame
        NSGraphicsContext.saveGraphicsState()
        let resizedFrame: NSRect = resizing.apply(rect: NSRect(x: 0, y: 0, width: 22, height: 25), target: targetFrame)
        context.translateBy(x: resizedFrame.minX, y: resizedFrame.minY)
        context.scaleBy(x: resizedFrame.width / 22, y: resizedFrame.height / 25)
        ...
        //// Group
        //// Text Drawing
        let textRect = NSRect(x: 13, y: 0, width: 13, height: 22)
        let textTextContent = "x"
        let textStyle = NSMutableParagraphStyle()
        textStyle.alignment = .left
        let textFontAttributes = [
        ...
        //// Text 2 Drawing
        let text2Rect = NSRect(x: 0, y: 3, width: 15, height: 24)
        let text2TextContent = "σ"
        let text2Style = NSMutableParagraphStyle()
        text2Style.alignment = .left
        let text2FontAttributes = [
            .font: NSFont.systemFont(ofSize: 22),
    ...
    @objc dynamic public class func drawSigmay(frame targetFrame: NSRect = NSRect(x: 0, y: 0, width: 22, height: 25), resizing: ResizingBehavior = .aspectFit) {
        //// General Declarations
        let context = NSGraphicsContext.current!.cgContext
    ...
    @objc dynamic public class func drawSumxy(frame targetFrame: NSRect = NSRect(x: 0, y: 0, width: 33, height: 31), resizing: ResizingBehavior = .aspectFit) {
        //// General Declarations
        let context = NSGraphicsContext.current!.cgContext
        ...
        //// Group
        //// Text Drawing
        let textRect = NSRect(x: 12, y: 4, width: 21, height: 22)
        let textTextContent = "xy"
        let textStyle = NSMutableParagraphStyle()
        textStyle.alignment = .left
        let textFontAttributes = [
            .font: NSFont(name: "HelveticaNeue", size: 20)!,
    ...
    @objc dynamic public class func drawStddevx(frame targetFrame: NSRect = NSRect(x: 0, y: 0, width: 22, height: 25), resizing: ResizingBehavior = .aspectFit) {
        //// General Declarations
        let context = NSGraphicsContext.current!.cgContext
        ...
        //// Text Drawing
        let textRect = NSRect(x: 13, y: 2, width: 13, height: 18)
        let textTextContent = "x"
        let textStyle = NSMutableParagraphStyle()
        textStyle.alignment = .left
        let textFontAttributes = [
        ...
        //// Text 2 Drawing
        let text2Rect = NSRect(x: 0, y: 5, width: 15, height: 20)
    ...
    @objc dynamic public class func drawStddevy(frame targetFrame: NSRect = NSRect(x: 0, y: 0, width: 22, height: 25), resizing: ResizingBehavior = .aspectFit) {
        //// General Declarations
        let context = NSGraphicsContext.current!.cgContext
